...
class Tachada(models.Model):
    total_mariri = models.DecimalField('Total Mariri',decimal_places=1,max_digits=5,blank=False)
    total_chacrona = models.DecimalField('Total Chacrona',decimal_places=1,max_digits=5,blank=False)
    mariri_panela = models.DecimalField('Mariri/Panela',decimal_places=1,max_digits=5,blank=True)
    chacrona_panela = models.DecimalField('Chacrona/Panela',decimal_places=1,max_digits=5,blank=True)
    ...
    hora_fervura = models.TimeField('Hora Fervura',auto_now=False, auto_now_add=False,blank=True)
    hora_saida = models.TimeField('Hora Saída',auto_now=False, auto_now_add=False,blank=True)
    agua_panela = models.DecimalField('Total água',decimal_places=1,max_digits=5,blank=True)
    litros_vegetal = models.DecimalField('Litros Vegetal',decimal_places=1,max_digits=5,blank=True)
    observacoes = models.TextField('Observações',max_length=250,blank=True)
